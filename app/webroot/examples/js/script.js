...
function onGoogleLoad() {
    ...
    gapi.client.load('youtube', 'v3', function() {
        ...
        request.execute(function(response) {
            ...
            container.append("<div class=\"video-wrapper\"<div class=\"featured-video\"><iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/"+ response.items[0].snippet.resourceId.videoId+"?autoplay=0&amp;rel=0&amp;showinfo=0&amp;modestbranding=1&amp;autohide=1\" frameborder=\"0\" allowfullscreen id=\"FeaturedVideoID\"></iframe></div></div>")
